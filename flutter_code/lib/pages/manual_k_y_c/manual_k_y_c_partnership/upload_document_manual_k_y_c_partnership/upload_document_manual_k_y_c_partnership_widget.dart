...
import 'upload_document_manual_k_y_c_partnership_model.dart';
export 'upload_document_manual_k_y_c_partnership_model.dart';

class UploadDocumentManualKYCPartnershipWidget extends StatefulWidget {
  const UploadDocumentManualKYCPartnershipWidget({super.key});

  @override
  State<UploadDocumentManualKYCPartnershipWidget> createState() =>
      _UploadDocumentManualKYCPartnershipWidgetState();
}

class _UploadDocumentManualKYCPartnershipWidgetState
    extends State<UploadDocumentManualKYCPartnershipWidget> {
  late UploadDocumentManualKYCPartnershipModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => UploadDocumentManualKYCPartnershipModel());
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: wrapWithModel(
                                              ...
                                              child: GenderInputWidget(
                                                label:
                                                    'List of partners with name, date of birth, and address on signed company letterhead',
                                              ),
                                            ),
                                          ),
                                          Padding(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: wrapWithModel(
                              ...
                              updateCallback: () => safeSetState(() {}),
                              child: GenderInputWidget(
                                label: 'Partnership firm declaration',
                              ),
                            ),
                          ),
                          Padding(
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: EdgeInsets.all(15.0),
                              child: wrapWithModel(
                                model: _model.uploadImageModel13,
                                updateCallback: () => safeSetState(() {}),
                                child: UploadImageWidget(
                                  title: 'Partner 1 Photo',
                                  callback: (base64Op) async {},
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: wrapWithModel(
                                ...
                                updateCallback: () => safeSetState(() {}),
                                child: UploadImageWidget(
                                  title: 'Partnership firm declaration',
                                  callback: (base64Op) async {},
                                ),
                              ),
                            ),
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: wrapWithModel(
                                ...
                                child: UploadImageWidget(
                                  title:
                                      'List of partners with name, date of birth, \nand address on signed company letterhead',
                                  callback: (base64Op) async {},
                                ),
                              ),
                            ),
