...
import 'customer_details_man_k_y_c_i_j_model.dart';
export 'customer_details_man_k_y_c_i_j_model.dart';

class CustomerDetailsManKYCIJWidget extends StatefulWidget {
  const CustomerDetailsManKYCIJWidget({super.key});

  @override
  State<CustomerDetailsManKYCIJWidget> createState() =>
      _CustomerDetailsManKYCIJWidgetState();
}

class _CustomerDetailsManKYCIJWidgetState
    extends State<CustomerDetailsManKYCIJWidget> {
  late CustomerDetailsManKYCIJModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomerDetailsManKYCIJModel());
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                model: _model.oTPInputCopyModel1,
                                updateCallback: () => safeSetState(() {}),
                                child: OTPInputCopyWidget(
                                  onOTPInputChange:
                                      (isOTPInputValid, testString) async {},
                                ),
                              ),
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      wrapWithModel(
                                        model: _model.oTPInputCopyModel2,
                                        updateCallback: () =>
                                            safeSetState(() {}),
                                        child: OTPInputCopyWidget(
