...
import 'confirm_payment_man_k_y_c_i_j_model.dart';
export 'confirm_payment_man_k_y_c_i_j_model.dart';

class ConfirmPaymentManKYCIJWidget extends StatefulWidget {
  const ConfirmPaymentManKYCIJWidget({super.key});

  @override
  State<ConfirmPaymentManKYCIJWidget> createState() =>
      _ConfirmPaymentManKYCIJWidgetState();
}

class _ConfirmPaymentManKYCIJWidgetState
    extends State<ConfirmPaymentManKYCIJWidget> {
  late ConfirmPaymentManKYCIJModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfirmPaymentManKYCIJModel());
