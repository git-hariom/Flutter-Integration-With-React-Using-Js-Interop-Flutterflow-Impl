...
import 'activate_tag_man_k_y_c_i_j_model.dart';
export 'activate_tag_man_k_y_c_i_j_model.dart';

class ActivateTagManKYCIJWidget extends StatefulWidget {
  const ActivateTagManKYCIJWidget({super.key});

  @override
  State<ActivateTagManKYCIJWidget> createState() =>
      _ActivateTagManKYCIJWidgetState();
}

class _ActivateTagManKYCIJWidgetState extends State<ActivateTagManKYCIJWidget> {
  late ActivateTagManKYCIJModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ActivateTagManKYCIJModel());
