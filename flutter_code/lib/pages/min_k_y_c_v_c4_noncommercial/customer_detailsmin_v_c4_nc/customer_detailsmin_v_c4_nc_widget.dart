...
import 'customer_detailsmin_v_c4_nc_model.dart';
export 'customer_detailsmin_v_c4_nc_model.dart';

class CustomerDetailsminVC4NcWidget extends StatefulWidget {
  const CustomerDetailsminVC4NcWidget({super.key});

  @override
  State<CustomerDetailsminVC4NcWidget> createState() =>
      _CustomerDetailsminVC4NcWidgetState();
}

class _CustomerDetailsminVC4NcWidgetState
    extends State<CustomerDetailsminVC4NcWidget> {
  late CustomerDetailsminVC4NcModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomerDetailsminVC4NcModel());
