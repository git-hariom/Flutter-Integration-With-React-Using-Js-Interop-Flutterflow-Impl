...
import 'confirm_payment_biometric_model.dart';
export 'confirm_payment_biometric_model.dart';

class ConfirmPaymentBiometricWidget extends StatefulWidget {
  const ConfirmPaymentBiometricWidget({super.key});

  @override
  State<ConfirmPaymentBiometricWidget> createState() =>
      _ConfirmPaymentBiometricWidgetState();
}

class _ConfirmPaymentBiometricWidgetState
    extends State<ConfirmPaymentBiometricWidget> {
  late ConfirmPaymentBiometricModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfirmPaymentBiometricModel());
