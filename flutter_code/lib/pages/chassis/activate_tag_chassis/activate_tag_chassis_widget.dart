...
import 'activate_tag_chassis_model.dart';
export 'activate_tag_chassis_model.dart';

class ActivateTagChassisWidget extends StatefulWidget {
  const ActivateTagChassisWidget({super.key});

  @override
  State<ActivateTagChassisWidget> createState() =>
      _ActivateTagChassisWidgetState();
}

class _ActivateTagChassisWidgetState extends State<ActivateTagChassisWidget> {
  late ActivateTagChassisModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ActivateTagChassisModel());
