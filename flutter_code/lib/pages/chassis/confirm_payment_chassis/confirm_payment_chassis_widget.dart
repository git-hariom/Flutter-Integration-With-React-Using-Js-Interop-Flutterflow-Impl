...
import 'confirm_payment_chassis_model.dart';
export 'confirm_payment_chassis_model.dart';

class ConfirmPaymentChassisWidget extends StatefulWidget {
  const ConfirmPaymentChassisWidget({super.key});

  @override
  State<ConfirmPaymentChassisWidget> createState() =>
      _ConfirmPaymentChassisWidgetState();
}

class _ConfirmPaymentChassisWidgetState
    extends State<ConfirmPaymentChassisWidget> {
  late ConfirmPaymentChassisModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfirmPaymentChassisModel());
                            ...
                            children: [
                              wrapWithModel(
                                ...
                                child: SearchBarWidget(
                                  placeholder: 'FASTag Details (Barcode)',
                                ),
                              ),
                              wrapWithModel(
                              ...
                              Container(
                                ...
                                child: wrapWithModel(
                                  ...
                                  child: ButtonWidget(
                                    isDisabled: false,
                                    onButtonClick: () async {
                                      context.pushNamed('ActivateTagChassis');
                                    },
                                  ),
                                ),
                              ),
