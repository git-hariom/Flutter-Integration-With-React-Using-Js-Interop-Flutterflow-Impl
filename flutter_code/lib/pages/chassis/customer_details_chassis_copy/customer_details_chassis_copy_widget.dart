...
import 'customer_details_chassis_copy_model.dart';
export 'customer_details_chassis_copy_model.dart';

class CustomerDetailsChassisCopyWidget extends StatefulWidget {
  const CustomerDetailsChassisCopyWidget({super.key});

  @override
  State<CustomerDetailsChassisCopyWidget> createState() =>
      _CustomerDetailsChassisCopyWidgetState();
}

class _CustomerDetailsChassisCopyWidgetState
    extends State<CustomerDetailsChassisCopyWidget> {
  late CustomerDetailsChassisCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomerDetailsChassisCopyModel());
