...
import 'user_details_chassis_model.dart';
export 'user_details_chassis_model.dart';

class UserDetailsChassisWidget extends StatefulWidget {
  const UserDetailsChassisWidget({super.key});

  @override
  State<UserDetailsChassisWidget> createState() =>
      _UserDetailsChassisWidgetState();
}

class _UserDetailsChassisWidgetState extends State<UserDetailsChassisWidget> {
  late UserDetailsChassisModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserDetailsChassisModel());
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: wrapWithModel(
                                  ...
                                  child: ButtonWidget(
                                    onButtonClick: () async {
                                      context.pushNamed('AddOnsChassis');
                                    },
                                  ),
                                ),
                              ),
