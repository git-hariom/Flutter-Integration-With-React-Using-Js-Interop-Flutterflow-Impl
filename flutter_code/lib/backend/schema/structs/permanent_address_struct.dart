...
class PermanentAddressStruct extends BaseStruct {
  ...
  static PermanentAddressStruct fromMap(Map<String, dynamic> data) =>
      PermanentAddressStruct(
  ...
  static PermanentAddressStruct? maybeFromMap(dynamic data) => data is Map
      ? PermanentAddressStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static PermanentAddressStruct fromSerializableMap(
  ...
  @override
  String toString() => 'PermanentAddressStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is PermanentAddressStruct &&
...
PermanentAddressStruct createPermanentAddressStruct({
  String? address1,
  String? address2,
  String? street,
  String? city,
