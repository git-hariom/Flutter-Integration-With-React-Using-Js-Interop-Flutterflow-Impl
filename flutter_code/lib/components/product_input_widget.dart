...
import 'product_input_model.dart';
export 'product_input_model.dart';
...
class _ProductInputWidgetState extends State<ProductInputWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductInputModel());
          ...
          child: Column(
            ...
            children: [
              FlutterFlowDropDown<String>(
                ...
                onChanged: (val) async {
                  safeSetState(() => _model.productValue = val);
