...
import 'mobile_number_input_model.dart';
export 'mobile_number_input_model.dart';
...
class _MobileNumberInputWidgetState extends State<MobileNumberInputWidget> {
  late MobileNumberInputModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MobileNumberInputModel());
